package com.xzy.utils.adaptscreen;
...
/**
 * 屏幕适配工具类。
 * 部分来自 https://github.com/Blankj/AndroidUtilCode/blob/master/lib/utilcode/src/main/
 * java/com/blankj/utilcode/util/AdaptScreenUtils.java
 *
 * @author xzy
 */
