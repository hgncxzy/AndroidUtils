package com.xzy.utils.activity;
...
public class ActivityUtils {
    ...
    /**
     * 获取显示在最顶端的 activity 名称
     *
     * @param context context
     * @return 最顶端的 activity 名称
     */
    public static String getTopActivityName(Context context) {
        String topActivityClassName = null;
        ActivityManager manager = (ActivityManager) (context.getSystemService
                (Context.ACTIVITY_SERVICE));
        List<ActivityManager.RunningTaskInfo> taskInfo = Objects.requireNonNull(manager)
                .getRunningTasks(1);
        if (taskInfo != null) {
     ...
     *
     * @param context context
     * @return 否运行在前台 true -- 是，false -- 否
     */
    public static boolean isRunningForeground(Context context) {
        String packageName = context.getPackageName();
        String topActivityClassName = getTopActivityName(context);
        Log.d(TAG, "packageName=" + packageName + ",topActivityClassName="
                + topActivityClassName);
        if (packageName != null && topActivityClassName != null && topActivityClassName
