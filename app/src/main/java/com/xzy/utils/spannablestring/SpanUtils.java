package com.xzy.utils.spannablestring;
    ...
    private void updateCharCharSequence() {
        ...
        if (start == 0 && lineHeight != -1) {// bug of LineHeightSpan when first line
            mBuilder.append(Character.toString((char) 2))
                    .append("\n")
                    .setSpan(new AbsoluteSizeSpan(0), 0, 2,
...
//            }
            ...
            canvas.drawText(text.toString(), x, y - ((y + fm.descent + y
                    + fm.ascent) / 2 - (bottom + top) / 2), paint);
        }
    }
