 ...
 * java/com/blankj/utilcode/util/CacheDoubleStaticUtils.java
 *
 * @author xzy
 */
...
public final class CacheDoubleStaticUtils {
     ...
     * @param cacheDoubleUtils The instance of {@link CacheDoubleUtils}.
     */
    public static void remove(@NonNull String key, @NonNull final CacheDoubleUtils
            cacheDoubleUtils) {
    ...
    private static CacheDoubleUtils getDefaultCacheDoubleUtils() {
        return sDefaultCacheDoubleUtils != null ? sDefaultCacheDoubleUtils
