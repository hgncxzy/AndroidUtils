...
public final class PermissionUtils2 {

    private static final List<String> PERMISSIONS = getPermissions();

    private static PermissionUtils2 sInstance;
    ...
    @TargetApi(Build.VERSION_CODES.M)
    private static void startOverlayPermissionActivity(final Activity activity,
     ...
     *
     * @param permissions The permissions.
     * @return the single {@link PermissionUtils2} instance
     */
    public static PermissionUtils2 permission(@PermissionConstants.Permission final String... permissions) {
        return new PermissionUtils2(permissions);
    }
    ...
    private PermissionUtils2(final String... permissions) {
     ...
     * @return the single {@link PermissionUtils2} instance
     */
    public PermissionUtils2 rationale(final OnRationaleListener listener) {
     ...
     * @return the single {@link PermissionUtils2} instance
     */
    public PermissionUtils2 callback(final SimpleCallback callback) {
     ...
     * @return the single {@link PermissionUtils2} instance
     */
    public PermissionUtils2 callback(final FullCallback callback) {
     ...
     * @return the single {@link PermissionUtils2} instance
     */
    public PermissionUtils2 theme(final ThemeCallback callback) {
        ...
        if (mOnRationaleListener != null) {
            for (String permission : mPermissionsRequest) {
                if (activity.shouldShowRequestPermissionRationale(permission)) {
                    ...
                    mOnRationaleListener.rationale(new PermissionUtils2.OnRationaleListener
                            .ShouldRequest() {
                        @Override
        ...
        protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            if (byteExtra == TYPE_RUNTIME) {
                if (sInstance == null) {
                    ...
                    Log.e("PermissionUtils2", "request permissions failed");
                    finish();
                    return;
                }
                ...
                if (sInstance.mPermissionsRequest != null) {
                    ...
                    requestPermissions(sInstance.mPermissionsRequest
                            .toArray(new String[size]), 1);
                }
