...
inline fun Fragment.dimen(@DimenRes dimenResId: Int) = requireContext().dimen(dimenResId)
...
inline fun Fragment.dimenPxSize(@DimenRes dimenResId: Int) =
...
inline fun Fragment.dimenPxOffset(@DimenRes dimenResId: Int) =
...
fun Context.styledDimen(@AttrRes attr: Int): Float =
        withStyledAttributes(attr) { getDimension(it, -1f) }

inline fun Fragment.styledDimen(@AttrRes attr: Int) = requireContext().styledDimen(attr)
...
fun Context.styledDimenPxSize(@AttrRes attr: Int): Int =
        withStyledAttributes(attr) { getDimensionPixelSize(it, -1) }

inline fun Fragment.styledDimenPxSize(@AttrRes attr: Int) = requireContext().styledDimenPxSize(attr)
...
fun Context.styledDimenPxOffset(@AttrRes attr: Int): Int =
        withStyledAttributes(attr) { getDimensionPixelOffset(it, -1) }

inline fun Fragment.styledDimenPxOffset(@AttrRes attr: Int) =
