...
/**
 * 分享的工具类。
 * 使用 ShareSDK 接入文档，请看这里 https://github.com/MobClub/ShareSDK-for-Android
 * 以及官网 http://www.mob.com
 *
 * @author xzy
 */
...
public class ShareSDKUtils {
     ...
     */
    private static void useDefaultGUI(String title, String content,
                                      String imgUrl, String siteUrl,
     ...
     * @param shareListener 分享的回调
     */
    private static void shareToWechat(String wechatType, int shareType, String title,
                                      String content, String siteUrl, String imgUrl,
                                      Bitmap bm, String imgPath,
                                      PlatformActionListener shareListener) {
        MobSDK.init(mContext);
        ...
        if (shareListener != null) {
            ...
            //如果为空，设置默认回调回调
            platform.setPlatformActionListener(defaultShareListener);
        }
    }
     ...
     * @param shareListener 分享的回调
     */
    private static void shareToQQ(String title, String content, String siteUrl,
                                  String imgUrl, Bitmap bm, String imgPath,
                                  PlatformActionListener shareListener) {
        MobSDK.init(mContext);
     ...
     * @param shareListener 分享的回调
     */
    private static void shareToSina(String content, String siteUrl, String imgUrl,
                                    Bitmap bm, String imgPath,
                                    PlatformActionListener shareListener) {
        MobSDK.init(mContext);
     ...
     * 默认的分享回调
     */
    public static PlatformActionListener defaultShareListener = new PlatformActionListener() {
        @Override
