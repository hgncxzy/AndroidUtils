 ...
 * java/com/liyi/sutils/utils/NfcUtil.java
 * @author xzy
 */
...
public class NfcUtils {
    ...
    public static NfcUtils getInstance() {
        return NfcUtils.NfcUtilsHolder.INSTANCE;
    }
    ...
    private NfcUtils() {
        mAdapter = NfcAdapter.getDefaultAdapter(UtilsApp.INSTANCE);
    }
