package com.xzy.utils.fragment;
 ...
 * java/com/blankj/utilcode/util/FragmentUtils.java
 *
 * @author xzy
 */
...
public final class FragmentUtils {
    ...
    public static void add(@NonNull final FragmentManager fm,
        ...
        add(fm, add, containerId, null, false, enterAnim, exitAnim,
                0, 0);
    }
    ...
    public static void add(@NonNull final FragmentManager fm,
                           ...
                           @AnimatorRes @AnimRes final int enterAnim,
                           @AnimatorRes @AnimRes final int exitAnim) {
        add(fm, add, containerId, null, isAddStack, enterAnim, exitAnim,
                0, 0);
    }
    ...
    public static void add(@NonNull final FragmentManager fm,
        ...
        add(fm, add, containerId, null, false, enterAnim, exitAnim, popEnterAnim,
                popExitAnim);
    }
    ...
    public static void add(@NonNull final FragmentManager fm,
                           ...
                           @AnimatorRes @AnimRes final int popEnterAnim,
                           @AnimatorRes @AnimRes final int popExitAnim) {
        add(fm, add, containerId, null, isAddStack, enterAnim, exitAnim, popEnterAnim,
                popExitAnim);
    }
    ...
    public static void add(@NonNull final FragmentManager fm,
                           ...
                           @AnimatorRes @AnimRes final int enterAnim,
                           @AnimatorRes @AnimRes final int exitAnim) {
        add(fm, add, containerId, tag, false, enterAnim, exitAnim, 0,
                0);
    }
    ...
    public static void add(@NonNull final FragmentManager fm,
                           ...
                           @AnimatorRes @AnimRes final int enterAnim,
                           @AnimatorRes @AnimRes final int exitAnim) {
        add(fm, add, containerId, tag, isAddStack, enterAnim, exitAnim, 0,
                0);
    }
    ...
    public static void add(@NonNull final FragmentManager fm,
                           ...
                           @AnimatorRes @AnimRes final int popEnterAnim,
                           @AnimatorRes @AnimRes final int popExitAnim) {
        add(fm, add, containerId, tag, false, enterAnim, exitAnim, popEnterAnim,
                popExitAnim);
    }
    ...
    public static void add(@NonNull final FragmentManager fm,
        ...
        if (tags == null) {
            for (int i = 0, len = adds.length; i < len; ++i) {
                putArgs(adds[i], new Args(containerId, null, showIndex != i,
                        false));
            }
        } else {
            for (int i = 0, len = adds.length; i < len; ++i) {
                putArgs(adds[i], new Args(containerId, tags[i], showIndex != i,
                        false));
            }
        }
    ...
    public static void replace(@NonNull final Fragment srcFragment,
                               ...
                               @AnimatorRes @AnimRes final int enterAnim,
                               @AnimatorRes @AnimRes final int exitAnim) {
        replace(srcFragment, destFragment, null, false, enterAnim, exitAnim,
                0, 0);
    }
    ...
    public static void replace(@NonNull final Fragment srcFragment,
                               ...
                               @AnimatorRes @AnimRes final int enterAnim,
                               @AnimatorRes @AnimRes final int exitAnim) {
        replace(srcFragment, destFragment, null, isAddStack, enterAnim, exitAnim,
                0, 0);
    }
    ...
    public static void replace(@NonNull final FragmentManager fm,
                               ...
                               @AnimatorRes @AnimRes final int enterAnim,
                               @AnimatorRes @AnimRes final int exitAnim) {
        replace(fm, fragment, containerId, null, false, enterAnim, exitAnim,
                0, 0);
    }
    ...
    public static void replace(@NonNull final FragmentManager fm,
                               ...
                               @AnimatorRes @AnimRes final int enterAnim,
                               @AnimatorRes @AnimRes final int exitAnim) {
        replace(fm, fragment, containerId, null, isAddStack, enterAnim, exitAnim,
                0, 0);
    }
    ...
    public static void replace(@NonNull final Fragment srcFragment,
                               ...
                               @AnimatorRes @AnimRes final int enterAnim,
                               @AnimatorRes @AnimRes final int exitAnim) {
        replace(srcFragment, destFragment, destTag, false, enterAnim, exitAnim,
                0, 0);
    }
    ...
    public static void replace(@NonNull final Fragment srcFragment,
                               ...
                               @AnimatorRes @AnimRes final int enterAnim,
                               @AnimatorRes @AnimRes final int exitAnim) {
        replace(srcFragment, destFragment, destTag, isAddStack, enterAnim, exitAnim,
                0, 0);
    }
    ...
    public static void replace(@NonNull final FragmentManager fm,
                               ...
                               @AnimatorRes @AnimRes final int enterAnim,
                               @AnimatorRes @AnimRes final int exitAnim) {
        replace(fm, fragment, containerId, destTag, false, enterAnim, exitAnim,
                0, 0);
    }
    ...
    public static void replace(@NonNull final FragmentManager fm,
                               ...
                               @AnimatorRes @AnimRes final int enterAnim,
                               @AnimatorRes @AnimRes final int exitAnim) {
        replace(fm, fragment, containerId, destTag, isAddStack, enterAnim, exitAnim,
                0, 0);
    }
